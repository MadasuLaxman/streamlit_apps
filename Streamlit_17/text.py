...
if uploaded_files is not None:
    ...
    if st.sidebar.button("All"):
        ...
        # Create a download button for the cleaned DataFrame
        if st.button("Download Cleaned DataFrame"):
            ...
            st.download_button(label="Click to Download", data=csv, file_name=filename, mime="text/csv")
