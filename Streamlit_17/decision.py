...
st.title("Decision Boundary Surface")
def main():
    ...
    add_selectbox = st.sidebar.slider(
        "Select the k value", min_value=1, max_value=11, step=2
    )
    ...
    datasets = {
        "ushape": r"C:\Users\madas\Downloads\Multiple CSV\Multiple CSV\1.ushape.csv",
        "concerticcir": r"C:\Users\madas\Downloads\Multiple CSV\Multiple CSV\2.concerticcir1.csv",
        "concerticcir2": r"C:\Users\madas\Downloads\Multiple CSV\Multiple CSV\3.concertriccir2.csv",
        "linearsep": r"C:\Users\madas\Downloads\Multiple CSV\Multiple CSV\4.linearsep.csv",
        "outlier": r"C:\Users\madas\Downloads\Multiple CSV\Multiple CSV\5.outlier.csv",
        "overlap": r"C:\Users\madas\Downloads\Multiple CSV\Multiple CSV\6.overlap.csv",
        "xor": r"C:\Users\madas\Downloads\Multiple CSV\Multiple CSV\7.xor.csv",
        "twospirals": r"C:\Users\madas\Downloads\Multiple CSV\Multiple CSV\8.twospirals.csv",
        "random": r"C:\Users\madas\Downloads\Multiple CSV\Multiple CSV\9.random.csv"
    }
    ...
    x_train, x_test, y_train, y_test = train_test_split(fv, cv, test_size=test_size_123, stratify=cv, random_state=random_state_1)
